...
if (sorts.next_field && sorts.next_field != "") {
    address = `${firstArg ? "&" : "?"}sort_next_field=${sorts.next_field}`
    firstArg = true;
}
if (sorts.before_field && sorts.before_field != "") {
    address = `${firstArg ? "&" : "?"}sort_before_field=${sorts.before_field}`
    firstArg = true;
}
